...
class TextileEditorHelperTest < Test::Unit::TestCase
  ...
  def test_textile_editor_simple_mode_with_complex_object_name
    assert_nil @textile_editor_ids
    create_simple_editor('article[:first]', 'body')
    assert_equal [['article_first_body', 'simple']], @textile_editor_ids
  end
